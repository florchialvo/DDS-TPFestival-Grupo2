...
object PersistenceSetUp extends App {
  ...
  Console.println(FestivalesHome.getFestival("Quilmes Rock").descuentosValidos)
  Console.println(FestivalesHome.getFestival("Quilmes Rock").entradasVendidas.map(_.nombre))
}